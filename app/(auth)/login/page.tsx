...
import { Mic, Loader2, Mail, Lock } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      <div className="w-full max-w-md px-8">
        ...
        {/* Form with Suspense */}
        <Suspense fallback={
          <div className="bg-white/10 backdrop-blur-xl rounded-2xl p-8 border border-white/10 flex items-center justify-center">
